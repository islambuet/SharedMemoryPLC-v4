...
class Structure extends Tag {
    ...
    _parseReadData (data, template) {
        ...
        //Moe
        //console.log('I am in Structure call. Data Length: ',data.length)
        //Moe
        let structValues = {};
        
        const {SINT, USINT, INT, UINT, DINT, UDINT, REAL, LINT, BIT_STRING, BOOL, STRUCT } = CIP.DataTypes.Types;
        ...
        template._members.forEach(member => {
            ...
            switch (member.type.structure ? STRUCT : member.type.code) {
                ...
                default:
                    throw new Error(
                        "Data Type SINT, USINT, INT, UINT, DINT, UDINT, REAL, LINT, BIT_STRING, BOOL, STRUCT returned "
                    );
            }
